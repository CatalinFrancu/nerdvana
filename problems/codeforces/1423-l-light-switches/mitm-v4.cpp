// In addition to v3, sort the righthand table by number of switches
// touched. Then we only need to scan it while we have hopes of improving.
#include <algorithm>
#include <stdio.h>
