// Brutish small-to-large. Each node stores this information about its
// subtree:
//
// 1. A map of color => frequency.
// 2. A multiset of just the frequencies.
//
// Uses STL liberally for extra slowness.
...
freq_info dfs(int u) {
  ...
  nd[u].color = 0; // prevent reentry without and extra parameter to DFS
