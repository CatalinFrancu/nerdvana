...
//
// Mo's algorithm. Maintain an array of frequencies and a second array with
// the number of values having each frequency (frequencies of frequencies, if
// you will).
#include <algorithm>
#include <stdio.h>
...
query q[MAX_QUERIES];
int answer[MAX_QUERIES]; // separate from q[] to avoid resorting at the end
int n, num_queries;
