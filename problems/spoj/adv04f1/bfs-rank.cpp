// 1. Rank combinations to map them to the contiguous range [0...70 choose 4).
// 2. Run BFS to compute distances.
// 3. Rank the given queries and print the answers.
#include <stdio.h>

typedef unsigned char byte;

const int SIZE = 70;
const int NUM_BOARDS = 916'895; // SIZE choose 4
const byte INFINITY = 0xff;
const int NUM_MOVES = 20; // 4 pieces, each having 2 slides and 3 jumps
