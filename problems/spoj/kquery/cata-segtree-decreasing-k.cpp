...
//
// Method: Process array elements and queries in decreasing value order. Use a
// segment tree as a boolean array. Before processing a query (i, j, k), mark
// the positions of all array elements greater than k in the segment tree.
// Then answer the query, which is just a range count.
//
// Note that a Fenwick tree suffices and is faster than the segment tree.
#include <algorithm>
#include <stdio.h>
